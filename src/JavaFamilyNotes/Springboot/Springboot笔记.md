...
* [SpringBoot 学习笔记]()
      ...
      * [4. 简化部署springboot应用]()
      * [5. Springboot启动细节探究]()
         * [5.1 <strong>POM文件</strong>]()
         * [5.2 <strong>Springboot的启动细节详解</strong>]()
            * [5.2.1 Springboot中启动相关的重要注解]()
            * [5.2.2 自动配置的原理]()
               * [5.2.2.1 <strong>@SpringBootApplication</strong>]()
               * [5.2.2.2 <strong>@EnableAutoConfiguration</strong>]()
               * [5.2.2.3 HttpEncodingAutoConfiguration 自动配置注解及流程详解]()
               * [5.2.2.4 debug模式下观察自动配置是否生效]()
      * [6. Sprintboot的相关配置及配置文件]()
         * [6.1 <strong>application.properties</strong> (名字是固定的)]()
         * [6.2 **application.yml **(名字是固定的)]()
            * [6.2.1 <strong>YAML的基本语法</strong>]()
            * [6.2.2 <strong>如何在指定的class内获取yml配置文件的值</strong>]()
            * [6.2.3 <strong>将yaml中的代码改写在application.properties中</strong>]()
            * [6.2.4 <strong>什么时候使用@Value或@ConfigurationProperties，有什么区别</strong>]()
         * [6.3 <strong>@PropertySource</strong>注解和**@ImportSource**注解的使用]()
            * [6.3.1 <strong>@PropertySource</strong>：加载指定的配置文件]()
            * [6.3.2 <strong>@ImportSource</strong>： 导入Spring的配置文件，让相应配置文件生效]()
         * [6.4 配置文件占位符]()
         * [<a name="user-content-开发环境切换">6.5 <strong>Springboot中的Profile/开发环境的切换</strong></a>]()
            * [6.5.1 <strong>多Profile文件的方式</strong>]()
            * [6.5.2 <strong>yml多文档块方式</strong>]()
            * [6.5.3 <strong>如何在命令行中激活指定profile</strong>]()
         * [6.6 配置文件的加载位置和加载顺序]()
            * [6.6.1 改变默认的配置文件位置]()
         * [6.7 外部配置加载顺序]()
            * [6.7.1 常用的场景]()
